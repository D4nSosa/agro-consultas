...
export class ChangeReport {
  ...
  renderReport(analysisData) {
    ...
    container.innerHTML = `
      <div id="printable-forest-report" class="card" style="padding: 25px; margin-top: 20px; border-top: 4px solid var(--verde-principal); box-sizing: border-box; overflow: hidden;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid var(--borde-suave); padding-bottom: 15px; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
          <div>
            <h2 style="margin: 0; color: var(--verde-principal); display: flex; align-items: center; gap: 10px; font-size: 1.3rem;">
            ...
            <div style="font-size: 0.9rem; color: var(--texto-secundario); margin-top: 5px;">
              Agro Consultas — Seguimiento Territorial e Información Satelital
            </div>
          </div>
        ...
        <!-- Metadatos del Lote -->
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; background: rgba(0,0,0,0.02); padding: 15px; border-radius: 8px; margin-bottom: 20px; box-sizing: border-box; overflow: hidden;">
        ...
        <h3 style="color: var(--verde-principal); border-bottom: 1px solid var(--borde-suave); padding-bottom: 5px; margin-top: 25px; font-size: 1.1rem;">
          📡 Trazabilidad de Fuentes de Datos Satelitales (Copernicus)
        </h3>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 15px; margin-bottom: 20px; box-sizing: border-box;">
          <div style="border: 1px solid var(--borde-suave); padding: 12px; border-radius: 8px; word-break: break-word; overflow: hidden;">
            ...
            <ul style="font-size: 0.85rem; margin: 8px 0 0 0; padding-left: 20px; line-height: 1.5;">
              ...
              <li style="word-break: break-all;"><strong>Identificador:</strong> ${prodA.id || 'N/A'}</li>
          ...
          <div style="border: 1px solid var(--borde-suave); padding: 12px; border-radius: 8px; word-break: break-word; overflow: hidden;">
            ...
            <ul style="font-size: 0.85rem; margin: 8px 0 0 0; padding-left: 20px; line-height: 1.5;">
              ...
              <li style="word-break: break-all;"><strong>Identificador:</strong> ${prodB.id || 'N/A'}</li>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; margin-bottom: 20px;">
          ${(aptitude?.recommendations || []).map(r => `
            <div style="border: 1px solid var(--borde-suave); border-radius: 8px; padding: 12px; word-break: break-word;">
        ...
        <div style="margin-top: 30px; padding: 12px; background: rgba(0,0,0,0.03); border: 1px solid var(--borde-suave); border-radius: 6px; font-size: 0.78rem; color: var(--texto-secundario); line-height: 1.5;">
          ...
          <br>
          Este reporte es un <em>Análisis preliminar de información territorial y teledetección</em> generado mediante la consulta de imágenes multiespectrales Sentinel-2 Level-2A provistas por Copernicus Data Space Ecosystem.
